...
contract WormholeRouter {
     ...
     */
    function requestMint(WormholeGUID calldata wormholeGUID, uint256 maxFeePercentage, uint256 operatorFeePercentage) external {
        ...
        GatewayLike(gateway).requestMint(wormholeGUID, maxFeePercentage, operatorFeePercentage);
    }
