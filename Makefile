...
certora-oracle 	:; certoraRun --solc ~/.solc-select/artifacts/solc-0.8.9 certora/WormholeOracleAuth.sol --verify WormholeOracleAuth:certora/WormholeOracleAuth.spec --rule_sanity $(if $(rule),--rule $(rule),) --multi_assert_check
